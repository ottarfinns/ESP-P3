...
#define LOWNET_PAYLOAD_SIZE \
  (LOWNET_FRAME_SIZE - (LOWNET_HEAD_SIZE + LOWNET_CRC_SIZE))  // 200 bytes.
...
static_assert(LOWNET_UNENCRYPTED_SIZE + LOWNET_IVT_SIZE +
...
typedef void (*lownet_recv_fn)(const lownet_frame_t* frame);
typedef void (*lownet_cipher_fn)(const lownet_secure_frame_t* in_frame,
                                 lownet_secure_frame_t* out_frame);
...
static const lownet_input_key_t base_shared_key = {
    {0xc0c71cc5, 0x748ce81a, 0x4b0e4aa7, 0x70c0d55e, 0x58957e01, 0xed51d8cc,
     0x26b844c4, 0x49c50530}};
static const lownet_input_key_t alt_shared_key = {
    {0x0b7b9b81, 0x350ecef1, 0x7a7b0fbb, 0xe9f134d2, 0x33bffa82, 0xc7c82730,
     0x4861bba3, 0x44e44aba}};
